...
let g:coc_global_extensions = ['coc-clangd', 'coc-git', 'coc-pyright', 'coc-json', 'coc-word', 'coc-syntax', 'coc-cmake', 'coc-clang-format-style-options', 'coc-sh', 'coc-snippets', 'coc-java']
" 'coc-html', 'coc-css',
" 'coc-yaml', 'coc-diagnostic',
" '@hexuhua/coc-copilot',
