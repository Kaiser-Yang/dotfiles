...
map.set({ 'n' }, 'j', [[(v:count == 0 ? 'j' : 'gj')]], { expr = true, noremap = true, silent = true })
map.set({ 'n' }, 'k', [[(v:count == 0 ? 'k' : 'gk')]], { expr = true, noremap = true, silent = true })
map.set({ 'n' }, '0', [[(v:count == 0 ? '0' : 'g0')]], { expr = true, noremap = true, silent = true })
