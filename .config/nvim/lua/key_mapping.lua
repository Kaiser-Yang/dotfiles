...
map_set_all({
    ...
    { { 'n', 'x' }, 'F', prev_find, { desc = 'Previous find character' } },
    { { 'n', 'x' }, 'f', next_find, { desc = 'Next find character' } },
    { { 'n', 'x' }, 'T', prev_till, { desc = 'Previous till character' } },
    { { 'n', 'x' }, 't', next_till, { desc = 'Next till character' } },
