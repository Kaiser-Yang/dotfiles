...
require('nvim-tree').setup({
  ...
  on_attach = function(buffer)
    ...
    local mapping = {
      ...
      { { 'n', 'x' }, 'y', a.fs.copy.node, opts('Yank') },
      { { 'n', 'x' }, 'd', a.fs.remove, opts('Delete') },
      ...
      { 'n', 'Y', h.tree.copy_node_information, opts('Yank Node Information') },
      ...
      { { 'n', 'x' }, 't', h.tree.copy, opts('Copy') },
      { { 'n', 'x' }, 'm', h.tree.move, opts('Move') },

      { 'x', 'b', a.marks.toggle, opts('Toggle Bookmark') },
      { 'n', 'bb', a.marks.toggle, opts('Toggle Bookmark') },
      { 'n', 'bd', a.marks.bulk.delete, opts('Delete Bookmarked') },
      { 'n', 'bm', a.marks.bulk.move, opts('Move Bookmarked') },
      -- TODO: this is not supported now
      -- { 'n', 'bt', a.marks.bulk.copy, opts('Copy Bookmarked') },
