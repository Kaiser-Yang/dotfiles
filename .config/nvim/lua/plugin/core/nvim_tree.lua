...
require('nvim-tree').setup({
  on_attach = function(buffer)
    ...
    local mapping = {
      ...
      { 'n', 'Y', h.nvim_tree.copy_node_information, opts('Copy Node Information') },
      { 'n', 'l', h.nvim_tree.open_folder_or_preview, opts('Open Folder or Preview') },
      { 'n', 'h', h.nvim_tree.collapse_or_go_to_parent, opts('Collapse or Go to Parent') },
      { 'n', '<cr>', h.nvim_tree.cd_or_open, opts('CD or Open') },
      { 'n', '<bs>', h.nvim_tree.cd_parent_directory, opts('CD parrent directory') },
      { { 'n', 'x' }, 'C', h.nvim_tree.copy_to, opts('Copy to') },
      { { 'n', 'x' }, 'R', h.nvim_tree.rename_full, opts('Rename Full Path or Move') },
