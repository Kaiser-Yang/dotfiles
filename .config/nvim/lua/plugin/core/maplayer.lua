...
local opts = {
  ...
  { key = '<leader>scc', desc = 'Config Path', handler = live_grep_c_dir, fallback = false },
  { key = '<leader>scl', desc = 'Lazy Path', handler = live_grep_l_dir, fallback = false },
  { key = '<leader>sfc', desc = 'Config Path', handler = find_files_c_dir, fallback = false },
  { key = '<leader>sfl', desc = 'Lazy Path', handler = find_files_l_dir, fallback = false },
