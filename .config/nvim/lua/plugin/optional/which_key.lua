...
w.add({
  ...
  { '<leader>w', icon = { icon = ' ', color = 'orange' }, mode = 'nox' },
  { '<leader>n', icon = { icon = ' ', color = 'orange' }, mode = 'nox' },
  { '<leader>T', icon = { icon = ' ', color = 'orange' }, mode = 'nox' },
  { '<leader><leader>', icon = { icon = ' ', color = 'orange' }, mode = 'nox' },
