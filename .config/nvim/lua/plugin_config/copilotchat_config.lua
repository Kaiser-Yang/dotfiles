-- You can define prompts like this
-- local prompts = {
...
return {
    {
        ...
        opts = {
            ...
            mappings = {
                ...
                -- We can use Q to quit and gpt to reopen the chat
                ...
                submit_prompt = {
                    normal = "<CR>",
                    -- in window terminal <alt-cr> will trigger <esc><cr>, so just use <alt><cr> to send
                    insert = false,
                },
                -- Accept the diff
                accept_diff = {
